...
const TOOLS_DATA = [
  ...
  // ---------------------------------------------------------
  {
    ...
    url: 'https://mnledu.com/kr/productivity/text-batch-factory_kr.html',
    icon: 'factory',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/data-slicer_kr.html',
    icon: 'scissors',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/copy-desk_kr.html',
    icon: 'clipboard-list',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/roster-maker_kr.html',
    icon: 'calendar-check',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/sheet2memo_kr.html',
    icon: 'layout-grid',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/smart-list_kr.html',
    icon: 'list-ordered',
    badge: 'NEW',
    tags: ['#목록', '#자동정리', '#SQL', '#복사']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/text-diff_kr.html',
    icon: 'diff',
    badge: 'NEW',
    tags: ['#계약서', '#비교', '#검수', '#문서']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/palette-picker_kr.html',
    icon: 'palette',
    badge: 'NEW',
    tags: ['#컬러', '#디자인', '#팔레트', '#브랜드']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/asset-hub_kr.html',
    icon: 'clipboard-copy',
    badge: 'NEW',
    tags: ['#에셋', '#복사', '#브랜드', '#자동화']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/data-harvester_kr.html',
    icon: 'database',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/pdf-signature_kr.html',
    icon: 'signature',
    badge: 'NEW',
    tags: ['#PDF', '#서명', '#문서', '#이미지']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/qr-studio_kr.html',
    icon: 'qr-code',
    badge: 'NEW',
    tags: ['#QR', '#인쇄', '#디자인', '#오프라인']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/meeting-minutes_kr.html',
    icon: 'clipboard-list',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/slot-coordinator_kr.html',
    icon: 'calendar-clock',
    badge: 'NEW',
    tags: ['#일정', '#미팅', '#시차', '#자동정리']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/notepad_kr.html',
    icon: 'notebook-pen',
    badge: 'BEST',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/emailgen_kr.html',
    icon: 'mail',
    badge: 'HOT',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/templatemerger_kr.html',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/promptmerger_kr.html',
    icon: 'files',
    badge: 'NEW',
    tags: ['#AI', '#텍스트', '#복사', '#개발']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/listformat_kr.html',
    icon: 'list-ordered',
    badge: null,
    tags: ['#텍스트', '#자동정리', '#목록', '#복사']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/textclean_kr.html',
    icon: 'eraser',
    badge: null,
    tags: ['#텍스트', '#자동정리', '#글자수']
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/anonymizer_kr.html',
    icon: 'shield-check',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/pdftxt_kr.html',
    icon: 'wrap-text',
    badge: null,
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/pdfmerge_kr.html',
    icon: 'file-stack',
    badge: 'BEST',
    tags: ['#PDF', '#문서작성', '#오프라인']
  },
  {
    ...
    title: '음성 인식 노트패드',
    category: 'PRODUCTIVITY',
    desc: '말한 내용을 받아 적고, 필요할 때 Whisper 기반 고정밀 AI로 마지막 녹음 구간을 다시 인식합니다.',
    url: 'https://mnledu.com/kr/productivity/voicenote_kr.html',
    icon: 'mic',
    badge: 'NEW',
    tags: ['#음성', '#받아쓰기', '#회의', '#텍스트']
  },
  ...
  // ---------------------------------------------------------
  {
    ...
    url: 'https://mnledu.com/kr/data-analytics/cagrcal_kr.html',
    icon: 'trending-up',
    badge: 'HOT',
  ...
  },
  {
    ...
    title: 'OCR 텍스트 추출기',
    category: 'DATA & ANALYTICS',
    desc: '이미지 속 글자를 텍스트로 뽑아냅니다. 고정밀 온디바이스 AI OCR과 문서 레이아웃 인식을 선택 적용할 수 있습니다.',
    url: 'https://mnledu.com/kr/data-analytics/ocrextract_kr.html',
    icon: 'scan-text',
    badge: null,
...

  {
    ...
    url: 'https://mnledu.com/kr/data-analytics/gov-fund-calc_kr.html',
    icon: 'calculator',
    badge: 'HOT',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/data-analytics/percent-calc_kr.html',
    icon: 'percent',
    badge: null,
    tags: ['#계산', '#마진', '#할인']
  },
  ...
  // ---------------------------------------------------------
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/birth-chart_kr.html',
    icon: 'orbit',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/biorhythm_kr.html',
    icon: 'activity',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/food-picker_kr.html',
    icon: 'utensils',
    badge: 'NEW',
    tags: ['#메뉴', '#추천', '#점심', '#쉬는시간']
  },
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/saju-studio_kr.html',
    icon: 'compass',
    badge: 'NEW',
    tags: ['#사주', '#만세력', '#성향', '#쉬는시간']
  },
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/kstartup-board_kr.html',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/youtubenote_kr.html',
    icon: 'clapperboard',
    badge: 'NEW',
    tags: ['#영상', '#학습', '#메모', '#자동저장']
  },

  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/date-calc_kr.html',
    icon: 'calendar-days',
    badge: 'NEW',
    tags: ['#날짜', '#계산', '#일정관리']
  },
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/unit-converter_kr.html',
    icon: 'ruler',
    badge: null,
    tags: ['#단위변환', '#계산', '#부동산']
  },
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/calculator_kr.html',
    icon: 'square-equal',
    badge: null,
    tags: ['#계산', '#수식', '#오프라인']
  },
  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/timezone-dial_kr.html',
    icon: 'globe',
    badge: 'NEW',
    tags: ['#시차', '#일정관리', '#해외']
  },

  {
    ...
    url: 'https://mnledu.com/kr/lifestyle/vocab-quiz_kr.html',
    icon: 'graduation-cap',
    badge: 'NEW',
  ...
  // ---------------------------------------------------------
  {
    ...
    url: 'https://mnledu.com/kr/design-media/advanced-image-tailor_kr.html',
    icon: 'crop',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/design-media/vocal-rhythm-master-studio_kr.html',
    icon: 'mic',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/design-media/thumb-mockup_kr.html',
    icon: 'monitor-play',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/design-media/uploader-toolkit_kr.html',
    icon: 'upload',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/productivity/image-studio_kr.html',
    icon: 'image',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/design-media/screendeco_kr.html',
    icon: 'frame',
    badge: 'HOT',
    tags: ['#이미지', '#발표자료', '#목업', '#캡처']
  },
  {
    ...
    url: 'https://mnledu.com/kr/design-media/mosaicmarker_kr.html',
    icon: 'highlighter',
    badge: null,
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/design-media/teleprompter_kr.html',
    icon: 'scroll-text',
    badge: null,
  ...
  // ---------------------------------------------------------
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/balance-game_kr.html',
    icon: 'scale',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/fashion-detector_kr.html',
    icon: 'shirt',
    badge: 'NEW',
    tags: ['#패션', '#색조합', '#재미', '#쉬는시간']
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/aggro-match_kr.html',
    icon: 'swords',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/tetris_kr.html',
    icon: 'gamepad-2',
    badge: 'NEW',
    tags: ['#게임', '#쉬는시간', '#오프라인']
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/sudoku_kr.html',
    icon: 'grid-3x3',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/snake_kr.html',
    icon: 'worm',
    badge: 'NEW',
  ...
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/minesweeper_kr.html',
    icon: 'bomb',
    badge: 'NEW',
    tags: ['#게임', '#퍼즐', '#쉬는시간', '#오프라인']
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/tarot_kr.html',
    icon: 'sparkles',
    badge: 'NEW',
    tags: ['#운세', '#타로', '#쉬는시간']
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/neon-ladder_kr.html',
    icon: 'waypoints',
    badge: 'NEW',
    tags: ['#게임', '#모임', '#랜덤', '#사다리']
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/horse-race_kr.html',
    icon: 'trophy',
    badge: 'NEW',
    tags: ['#게임', '#모임', '#랜덤', '#내기']
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/lotto_kr.html',
    icon: 'clover',
    badge: 'NEW',
    tags: ['#랜덤', '#로또', '#쉬는시간']
  },
  {
    ...
    url: 'https://mnledu.com/kr/entertainment/russian-roulette_kr.html',
    icon: 'dices',
    badge: 'NEW',
    tags: ['#게임', '#모임', '#랜덤', '#쉬는시간']
  },

  {
    ...
    url: 'https://mnledu.com/kr/productivity/presentation-timer_kr.html',
    icon: 'timer',
    badge: 'NEW',
    tags: ['#발표', '#타이머', '#회의', '#진행']
  }
